...
export default function App() {
  ...
  return (
    ...
    <div className="">
      <Navbar className="bg-transparent border-transparent sticky top-0 z-10 h-max max-w-full rounded-none px-4 py-2 lg:px-8 lg:py-4">
